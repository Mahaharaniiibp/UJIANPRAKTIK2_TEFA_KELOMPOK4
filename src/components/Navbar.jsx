      ...
      <div className="flex items-center justify-between">
        <div className="mx-7">
          <h4 className="flex items-center justify-start text-4xl uppercase font-bold">
            <span className="text-yellow-400 text-4xl">FOURTYK</span>
          </h4>
        </div>
        <div className="md:bg-white/0 bg-white text-white md:block hidden px-7 py-2 font-medium bg-white rounded-bl-full">
